...
HD_PWD='D:/VivadoProjects/minized_with_AD1_gpio/minized_with_AD1_gpio.runs/minized_petalinux_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minized_petalinux_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minized_petalinux_axi_gpio_0_0.tcl
