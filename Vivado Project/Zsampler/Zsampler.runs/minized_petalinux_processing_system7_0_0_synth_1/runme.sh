...
HD_PWD='D:/VivadoProjects/fft_system/fft_system.runs/minized_petalinux_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minized_petalinux_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minized_petalinux_processing_system7_0_0.tcl
