...
HD_PWD='D:/VivadoProjects/fft_system/fft_system.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log minized_petalinux_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source minized_petalinux_wrapper.tcl -notrace
