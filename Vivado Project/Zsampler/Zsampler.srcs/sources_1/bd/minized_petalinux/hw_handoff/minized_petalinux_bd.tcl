...
proc create_root_design { parentCell } {
  ...
  set cs_n_0 [ create_bd_port -dir O -from 0 -to 0 cs_n_0 ]
  set data_in_0_0 [ create_bd_port -dir I data_in_0_0 ]
  set data_in_1_0 [ create_bd_port -dir I data_in_1_0 ]
  ...
  # Create instance: pmod_adc_ad7476a_0, and set properties
  set block_name pmod_adc_ad7476a
  set block_cell_name pmod_adc_ad7476a_0
  if { [catch {set pmod_adc_ad7476a_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pmod_adc_ad7476a_0 eq "" } {
  ...
  # Create instance: sampler_with_stream_0, and set properties
  set sampler_with_stream_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Custom_Sample_Generator:1.0 sampler_with_stream_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins axi_gpio_2/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins ps7_0_axi_periph/M07_AXI] [get_bd_intf_pins sampler_with_stream_0/S00_AXI]
  connect_bd_intf_net -intf_net sampler_with_stream_0_M00_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins sampler_with_stream_0/M00_AXIS]
  ...
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins xfft_0/s_axis_config_tdata]
  ...
  connect_bd_net -net data_in_0_0_1 [get_bd_ports data_in_0_0] [get_bd_pins pmod_adc_ad7476a_0/data_in_0]
  connect_bd_net -net data_in_1_0_1 [get_bd_ports data_in_1_0] [get_bd_pins pmod_adc_ad7476a_0/data_in_1]
  connect_bd_net -net pmod_adc_ad7476a_0_adc_0_data [get_bd_pins pmod_adc_ad7476a_0/adc_0_data] [get_bd_pins sampler_with_stream_0/channel0]
  connect_bd_net -net pmod_adc_ad7476a_0_adc_1_data [get_bd_pins pmod_adc_ad7476a_0/adc_1_data] [get_bd_pins sampler_with_stream_0/channel1]
  connect_bd_net -net pmod_adc_ad7476a_0_cs_n [get_bd_ports cs_n_0] [get_bd_pins pmod_adc_ad7476a_0/cs_n]
  connect_bd_net -net pmod_adc_ad7476a_0_sck [get_bd_ports sck_0] [get_bd_pins pmod_adc_ad7476a_0/sck]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins bluetooth_uart/s_axi_aclk] [get_bd_pins pmod_adc_ad7476a_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins sampler_with_stream_0/m00_axis_aclk] [get_bd_pins sampler_with_stream_0/s00_axi_aclk] [get_bd_pins xfft_0/aclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins pmod_adc_ad7476a_0/reset_n] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins bluetooth_uart/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins sampler_with_stream_0/m00_axis_aresetn] [get_bd_pins sampler_with_stream_0/s00_axi_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs bluetooth_uart/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sampler_with_stream_0/S00_AXI/S00_AXI_reg] -force
